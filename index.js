var nyt ="5RKjt3e0qciAQ5iP2TAxmz5WBtZyVBsC"; // NYT API KEY
var goog ="AIzaSyA2guuAW5CltyJEAl0rQld60XE65ukoZO4"; // Google Books Key



fetch('https://api.nytimes.com/svc/books/v3/lists.json?list-name=hardcover-fiction&api-key='+nyt, {
    method: 'get',
  })
...
function updateCover(id, isbn) {
  fetch('https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn+"&key=" + goog, {
    method: 'get'
  })
  .then(response => { return response.json(); })
  .then(data => {
